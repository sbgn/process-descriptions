...
The text that appears as the unit of information decorating an Entity Pool Node (EPN) for cases where there is a controlled vocabulary defined in either (\sect{material-types-cv} or \sect{conceptual-types-cv}) must use these prefixes indicating the type of information being expressed. Without the use of controlled vocabulary prefixes, it would be necessary to have different glyphs to indicate different classes of information; this would lead to an explosion in the number of glyphs needed.
