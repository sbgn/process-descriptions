\usepackage{graphicx}
\usepackage[breaklinks=true,colorlinks=true,plainpages=false,
...
\usepackage[rgb,hyperref,table]{xcolor}
...
\usepackage{amssymb}
% use package textcomp to avoid warning from package gensymb about missing macros
