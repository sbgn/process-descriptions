...
\jibtitle{Systems Biology Graphical Notation:\\Process Description language Level~1 Version~2.1}
...
\jibauthor{Hasan Balci\iref[,]{hasan}\textsuperscript{*},
Adrien Rougny\iref[,]{adrien}\jibauthorfootnote{*}{These authors contributed equally to this work.},
           Rupert Overall\iref{rupert},
           Irina Balaur\iref{adrien},
           ...
           Alexander Mazein\iref{adrien},
           Huaiyu Mi\iref{huaiyu},
           Stuart Moodie\iref{stuart},
           Falk Schreiber\iref[,]{hanna}\iref{falk2},
...
\addjibinstitution{andreas1}{Data Analytics and Bioinformatics, Institute of Computer Science, Martin Luther University Halle-Wittenberg, Von-Seckendorff-Platz 1, 06120 Halle (Saale), Germany}
\addjibinstitution{andreas2}{Quantitative Biology Center (QBiC), Institute for Bioinformatics and Medical Informatics (IBMI), Eberhard Karl University of Tübingen, Ottfried-Müller-Str. 37, 72076 Tübingen, Germany}
\addjibinstitution{andreas3}{German Center for Infection Research (DZIF), partner site Tübingen, Germany}
...
\addjibinstitution{stuart}{Novo Nordisk A/S, Research and Early Development, Novo Nordisk Park 1, 2760 Måløv, Denmark}
\addjibinstitution{falk2}{Faculty of Information Technology, Monash University, Melbourne, Australia}
\addjibinstitution{anatoly}{Biological Systems Unit, Okinawa Institute of Science and Technology, Japan}
