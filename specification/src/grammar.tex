...
% \includegraphics[width=0.6\linewidth]{images/build/sbgn_node_taxonomy.pdf}
...
% \begin{figure}[p]
% \begin{center}
% \includegraphics[width=0.5\linewidth]{images/build/sbgn_visual.pdf}
...
% \begin{figure}[p]
% \begin{center}
% \includegraphics[width=0.85\linewidth]{images/build/sbgn_conceptual.pdf}
