...
\label{sec:epn-rules}
 ...
 \begin{enumerate}
   \item All \glyph{state variables} associated with a stateful EPN should be unique and not duplicated within that node if names of the state variables are provided.
...
\item All process nodes (with the exception of \glyph{phenotype}) must have a LHS and RHS.
    ...
    display their stoichiometry make-up.
...
compartment   & N & & \\\hline
simple chemical & Y & \glyph{Simple clone marker} & \\\hline
unspecified entity & Y & \glyph{Simple clone marker} & \\\hline
empty set & Y & None & \\\hline
perturbing agent & Y & \glyph{Simple clone marker} & \\\hline

simple chemical multimer & Y & \glyph{Simple clone marker} & \\\hline
stateful EPN & Y & \glyph{Labelled clone marker} & \\\hline
macromolecule & Y & \glyph{Labelled clone marker} & \\\hline
macromolecule multimer & Y & \glyph{Labelled clone marker} & \\\hline
nucleic acid feature & Y & \glyph{Labelled clone marker} & \\\hline
complex & Y & \glyph{Labelled clone marker} & \\\hline
process & Y & None & \\\hline
omitted process & Y & As Process  & \\\hline
uncertain process & Y & As Process  & \\\hline
association & Y & As Process  & \\\hline
dissociation & Y & As Process  & \\\hline
phenotype & Y & None & \\\hline
logical operator & Y & None & \\\hline
and & Y & None & \\\hline
or & Y & None & \\\hline
not & Y & None & \\\hline
...
An \glyph{EPN} cannot -belong to more than one
...
correct way a macromolecule that spans more than one compartment ---
...
inside). Therefore, the author should draw the
...
The submap is a visual device that allows the detail of a \PD map to be exported into another \PD map and replaced by a \glyph{submap} glyph, which acts as a place-holder. This is described and illustrated in \sect{submap}. In the following discussion we will refer to the original map as the \emph{main} map and the map containing the export detail as the submap. 
