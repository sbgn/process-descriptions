...
\glyph{Subunits} do not represent or mimic entity pools~(\sect{EPNs}), so they cannot be cloned and may only be used to represent the subunits included in a complex.
...
The remaining four \glyph{subunits} are multimeric: \glyph{macromolecule multimer subunit}, \glyph{simple chemical multimer subunit}, \glyph{nucleic acid feature multimer subunit}, and \glyph{complex multimer subunit}.
...
\glyphContainer
Each \glyph{subunit} is represented by its own shape depending on its bio-molecular nature, as shown in \fig{subunit_containers}.
...
A \glyph{complex subunit} can carry \glyph{subunits} and there is no limit on such nesting. 
...
\begin{tabu}{X[c,m]X[c,m]X[c,m]X[c,m]}
    ...
    \glyph{complex subunit} & \glyph{macromolecule multimer subunit} & \glyph{simple chemical multimer subunit} & \glyph{nucleic acid feature multimer subunit}\\[0.5cm]
    \includegraphics[scale=0.8, valign=m]{images/build/complex_multimer_subunit.pdf} &  &  & \\[0.2cm]
    \glyph{complex multimer subunit} & & & \\
\end{tabu}
