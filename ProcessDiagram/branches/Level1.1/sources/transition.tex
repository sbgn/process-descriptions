% $HeadURL: https://sbgn.svn.sourceforge.net/svnroot/sbgn/trunk/documents/specifications/ProcessDiagram/Level1/sources/transition.tex $
...
A transition is a process transforming a set of entities (represented by \glyph{EPNs} in \SBGNPDLone) into another set entities.
