...
A \PD{} in SBGN describes biological processes involving biological entities. An \glyph{Entity pool node} (\sect{EPNs}), such as a molecule, is converted into other \glyph{EPNs} via a \glyph{process}. 
