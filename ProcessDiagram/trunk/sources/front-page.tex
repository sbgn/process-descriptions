...
% Level~1 Release 1.1 specification.  It is not a normative document.
% \end{minipage}}
...
\begin{minipage}{5in}
  \emph{To discuss any aspect of SBGN, please send your messages
    ...
    please write to \mailto{sbgn-editors@lists.sourceforge.net}. Bug reports and specific comments about the specification should be entered in the issue tracker \url{http://sourceforge.net/tracker/?group_id=178553&atid=1082245}.}
\end{minipage}
