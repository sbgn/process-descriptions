...
\SBGNPDLone{} contains six glyphs representing classes of material entities: \glyph{unspecified entity}, \glyph{simple chemical}, \glyph{macromolecule}, \glyph{nucleic acid feature}, \glyph{multimer} and \glyph{complex}.  (Specific types of macromolecules, such as protein, RNA, DNA, polysaccharide, and specific simple chemicals are not defined by \SBGNPDLone but may be part of future levels of SBGN.)  In addition to the material entities, \SBGNPDLone{} represents three conceptual entities: \glyph{source/sink}, \glyph{perturbing agent}, and \glyph{tag}.  Material and conceptual entities can optionally carry auxiliary units such as \glyph{units of information}, \glyph{state variables} and \glyph{clone markers}.
