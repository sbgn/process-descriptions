...
The \sbgnclass{AuxiliaryUnit} represents symbols that may be used to
...
The \sbgnclass{SBGNNode} represents the nodes in the graph structure
...
The \sbgnclass{SBGNArc} represents the arcs (also know as edges) in
...
\tablecaption{Mapping between the subunit types and the glyphs used to
  represent it. These are essentially the EPN glyphs describe in this document.}
