...
\newenvironment{glyphIdentity}{%
\item[Attributes:]\mbox{}
 \begin{compactitem}}%
  {\end{compactitem}}
...
\newcommand{\attitem}[2]{\item[\attrib{#1}:\sbgnclass{#2}]}
...
% \newcommand{\glyphAux}{\item[Permitted Child Glyphs:]\mbox{}\newline}
...
% \newcommand{\glyphCloning}{\item[Cloning:]\mbox{}\newline}
% \newcommand{\glyphRules}{\item[Special constraints or rules:]\mbox{}\newline}
