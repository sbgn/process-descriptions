...
\glyphNode A transition is represented by a square box linked to two arcs attached to the centers of opposite sides. The consumption (\sect{consumption}) and production (\sect{production}) arcs are linked to the extremities of the transition arcs. The modulatory arcs (\sect{arcs}) point to the other two sides. A \glyph{transition} connected to \glyph{production} arcs on opposite sides is a reversible transition.
...
The example in \fig{trans-phos} illustrates the use of a \glyph{transition} node to represent the phosphorylation of a protein in a \PD.
...
The example in \fig{trans-react} illustrates the use of a \glyph{transition} node to represent an reaction between two reactants that generates three products. 
...
The example in \fig{trans-reverse} illustrates the use of a \glyph{transition} node to represent the reversible opening and closing of an ionic channel in a \PD.
