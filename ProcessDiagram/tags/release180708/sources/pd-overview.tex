...
\begin{table}[bh]
  ...
  \begin{tabular}{@{}llP{2.4in}P{1.6in}@{}}
    ...
    Connecting arc
    & ---
    & Links from EPNs to PNs to indicate influence by the EPNs on the PNs
    & Stimulation, modulation, catalysis, inhibition \\[0.5em]
