...
% Pass options to xcolor. This is called by other packages so an
% explicit call later leads to an error.
\ifpdf
  % Using pdflatex
  \PassOptionsToPackage {pdftex,rgb,usenames,dvipsnames,svgnames,hyperref,table}{xcolor}
\else
  % Case: not using pdflatex
 \PassOptionsToPackage{rgb,dvipsnames,svgnames,hyperref,table}{xcolor}
\fi
...
% [!] FIXME [!]
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Trying to fix the bug with RoyalBlue not compiling, attempt 1
% Define the link colour directly in RGB
%
%\definecolor{NavigationBlue}{RGB}{65,105,225}
%\usepackage[pdftex,breaklinks=true,colorlinks=true,plainpages=false,pdfpagelabels,bookmarks=true,bookmarksopen=true,bookmarksopenlevel=2,pdfhighlight=/O,linkcolor={NavigationBlue},citecolor={NavigationBlue},pagecolor={NavigationBlue},urlcolor={NavigationBlue}]{hyperref}
%
% if this fail, try to add \usepackage{color} somewhere relevant
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Trying to fix the bug with RoyalBlue not compiling, attempt 2
% Use a simpler colour name which should be more readily recognised
\usepackage[pdftex,breaklinks=true,colorlinks=true,plainpages=false,pdfpagelabels,bookmarks=true,bookmarksopen=true,bookmarksopenlevel=2,pdfhighlight=/O,linkcolor={blue},citecolor={blue},pagecolor={blue},urlcolor={blue}]{hyperref}
%
% if this fail, try to add \usepackage{color} somewhere relevant
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%Trying to fix the bug with RoyalBlue not compiling, attempt 3
% Keep the original line but make sure the xcolor package is actually called
%
% comment out the following line if there seems to be a conflict later on (package called twice)
%  \usepackage[pdftex,rgb,usenames,dvipsnames,svgnames,hyperref,table]{xcolor}
% Maybe replace with \PassOptionsToPackage, cf start of file?
%
% This line should now work if the xcolor package has been imported alright
%\usepackage[pdftex,breaklinks=true,colorlinks=true,plainpages=false,pdfpagelabels,bookmarks=true,bookmarksopen=true,bookmarksopenlevel=2,pdfhighlight=/O,linkcolor={RoyalBlue},citecolor={RoyalBlue},pagecolor={RoyalBlue},urlcolor={RoyalBlue}]{hyperref}
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%/ [!] FIXME [!]
...
%   {subparagraph}{5}{0pt}{-1.5ex \@plus -1ex \@minus -.2ex}%
%   {0.5ex}{\slshape\normalsize\bfseries\sffamily}}
