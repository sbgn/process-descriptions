...
The present user manual will present the various symbols used by \SBGNPDLone (\chap{symbols}), and provide guidance to design SBGN \PDms (\chap{build}). The authors tried to keep the presentation simple, and to avoid being too technical. 
