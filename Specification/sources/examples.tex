...
\begin{figure}[htb]
\begin{center}
\scalebox{0.2}{\includegraphics{examples/insulin}}
...
\caption{The insulin-like growth factor (IGF) signalling map with an expanded submap that contains the MAPK cascade (in yellow). See also \fig{insulin}.}\label{fig:mapk}
\end{center}
\end{figure}
