...
\begin{glyphDescription}
 ...
 \glyphNode \glyph{Equivalence} is represented by a circle carrying letter "xi" of the Greek alphabet. The choice of the symbol is motivated by its use in mathematics for describing relationships as "equivalent to" or "identical to". 
\end{glyphDescription}
