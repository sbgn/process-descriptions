...
\begin{glyphDescription}
 ...
 \glyphNode \glyph{Equivalence} is represented by a circle carrying uppercase letter "xi" of the Greek alphabet. The choice of the symbol is motivated by its use in mathematics for describing relationships as "equivalent to", "identical to". 
\end{glyphDescription}

\begin{figure}[htb]
  \centering
  \includegraphics[scale = 0.5]{images/equivalence}
  \caption{The \PD glyph for \glyph{equivalence}. Only two inputs are represented, but more would be allowed.}
