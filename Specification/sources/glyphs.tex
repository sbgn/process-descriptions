...
\begin{valrules}
% \newglossaryentry{Rule001}
% {
%     name=Rule001,
%     description={All instances of \sbgnclass{EntityPoolNode} associated with a
%   particular \sbgnclass{EntityType} must be of the same class.}
% }
% \item[\gls{Rule001}] All instances of \sbgnclass{EntityPoolNode} associated with a
%   particular \sbgnclass{EntityType} must be of the same class.
\defrule{Rule001}{All instances of \sbgnclass{EntityPoolNode} associated with a
  particular \sbgnclass{EntityType} must be of the same class.}
\defrule{Rule002}{If an instance of \sbgnclass{EntityType} contains one or more
