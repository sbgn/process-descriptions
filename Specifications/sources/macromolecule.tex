...
Attempting to define a separate glyph for all of these different molecules would lead to an explosion of symbols in SBGN, so instead, \SBGNPDLone \corr{defines}{specifies} only one glyph for all macromolecules.
...
% \dogrusoz{I agree with these suggested changes.}
...
\glyphLabel
A \glyph{macromolecule} is identified by a label \corr{an unbordered box containing}{} that is a string of characters \corr{.
