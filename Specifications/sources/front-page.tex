...
Alexander Mazein & \emph{EISBM, France}\\
Huaiyu Mi	 & \emph{University of Southern California, USA}\\
Nicolas \lenov   & \emph{Institute, UK}\\
...
\begin{minipage}{5in}
  \emph{To discuss any aspect of SBGN, please send your messages
    ...
    please write to \mailto{sbgn-editors@lists.sourceforge.net}. Bug reports and specific comments about the specification should be entered in the issue tracker \url{https://github.com/sbgn/process-descriptions/issues}.}
\end{minipage}
