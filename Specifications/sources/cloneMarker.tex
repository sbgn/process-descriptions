\subsection{Glyph\add{s}: \glyph{Clone marker\add{s}}}
...
\subsubsection{\corr{Glyph: }{}\glyph{Simple clone marker}}
...
\glyphLabel
\corr{A \glyph{simple clone marker} is not identified by any label.}{None.}

\glyphAux
\corr{A \glyph{simple clone marker} does not carry any auxiliary items.}{None.}
...
\begin{figure}[H]
  ...
  \caption{The \PD glyph for \glyph{simple clone marker} applied to a \glyph{simple chemical}\corr{, a \glyph{phenotype}}{} and a \glyph{multimer} of \glyph{simple chemicals}.}
...
\glyphLabel
A \glyph{labelled clone marker} is identified by a label that is \corr{an unbordered box containing}{} a string of characters \corr{.
...
\glyphAux
\corr{A \glyph{labelled clone marker} does not carry any auxiliary items.}{None.}
