...
The \glyph{necessary stimulation} instead represents \corr{this \corr{absolute}{necessary} stimulation}{the necessity for the receptor to be present for the transport to take place}.
