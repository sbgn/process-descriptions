...
A \glyph{process} represents a generic process that transforms a set of entity pools (represented by \glyph{EPNs} in \SBGNPDLone) into another set of entity pools.
...
A process is regarded as reversible if both ports of the process are connected to \glyph{production} arcs (see section \ref{sec: semantics reversible procs}).
